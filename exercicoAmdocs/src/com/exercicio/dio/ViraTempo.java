 ...
 * O artefato ainda está em desenvolvimento e ele prometeu consertar os bugs e colocar uns
 * apetrechos melhores e, em troca, pediu um sistema simples para o modo Standy Bay.
 * O problema é que o artefato por si só sempre tem o ângulo de inclinação do Sol/Lua(de 0 a 360).
 * Valendo um Vira Tempo, caso deseja aceitar: dada em grau da inclinação do Sol/Lua, informe em qual
 ...
 *
 * Saída
 * Imprima uma saudação referente ao período do dia que ele se encontra: "Boa Tarde!!", "Boa Noite!!",
 * "Bom Dia!!" e "De Madrugada!!".
 *
 ...
 */
        ...
        while ( leitor.hasNext()) {
            ...
            if (graus >= 0 && graus < 90 || graus == 360 )
                ...
                System.out.println("Valor fora do parametro! Digite valores entre o e 360º");
                break;
